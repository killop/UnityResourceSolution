...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
       ...
       // }
        ...
        static List<AssetBundleDataSource.ABDataSource> m_DataSourceList = new List<AssetBundleDataSource.ABDataSource>();
        ...
        public static void URSShowWindow()
        {
            s_instance = null;
            instance.titleContent = new GUIContent("AssetBundles");
            instance.Show();
        ...
        private void InitDataSources()
        {
            ...
            //AssetBundleModel.Model.DataSource = m_DataSourceList[0];
            //if (m_DataSourceList == null)
            //{
