...
{
    [CustomPropertyDrawer(typeof(TagRule))]
    internal class TagRulePropertyDrawer : LibraryRuleBasePropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            matchTypeField.BindProperty(property.FindPropertyRelative("_tagType"));
